...
def get_scale_factor (target_gene_sorted, gene_id, expression_profile, percent_low, percent_high):
...
def get_gene_expression_above_percent(target_gene_sorted, gene_id, percent_low, percent_high):
